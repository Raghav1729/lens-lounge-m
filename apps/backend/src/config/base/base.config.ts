...
import { PayPalKeysType } from '../../../../payment-service/src/config/pay-pal/types/pay-pal-keys.type';
import { TelegramKeysType } from '../telegram/types/telegram-keys.type';
import { StripeKeysType } from '../../../../payment-service/src/config/stripe/types/stripe-keys.type';
